...
<body>
    ...
    <div class="clause">
        ...
        <p><strong>9.1.1.</strong> O LOCATÁRIO pagará ao LOCADOR o valor de <strong>R$ {{ number_format($locacao->Veiculo->valor_semana, 2, ',', '.') }} ({{ \App\Helpers\NumeroPorExtenso::real($locacao->Veiculo->valor_semana) }})</strong> toda 
